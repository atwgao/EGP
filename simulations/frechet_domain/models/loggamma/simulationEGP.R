...
K<-m:(n-1)
pdf(file="../../results_plots/EGP_loggamma_xi.pdf",width = 6, height = 6)
par(mar=c(3,5,1,5))
...
pdf(file="../../results_plots/EGP_loggamma_rmse.pdf",width = 6, height = 6)
par(mar=c(5,5,5,2))
...
pdf(file="../../results_plots/EGP_loggamma_var.pdf",width = 6, height = 6)
par(mar=c(5,5,5,2))
...
save.image(file="../../results_rdata/loggamma_imagefileEG.RData")
